	...
	<div class="mainmenu-wrapper">
		<div class="container">
			<div class="menuextras">
				<div class="extras">
					<ul>
						<li class="shopping-cart-items" style="display:none"><i
							class="glyphicon glyphicon-shopping-cart icon-white"></i> <a
							href="AfficheShoppingCartServlet"><b id="nbArticlesPanier"> 0 </b></a></li>
			...
			<nav id="mainmenu" class="mainmenu">
				<ul>
					...
					<li><a href="AfficheCatalogServlet">Catalogue</a></li>
